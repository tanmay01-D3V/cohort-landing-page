...
const App = () => {
  ...
  function SmileyModel() {
    const mask = useTexture("/Frame 1.png");
  ...
  return (
    <div className="w-full bg-[#FEA903] bg-gradient-to-t from-[#FEA903] to-[#FFC600] min-h-screen">
      <div className="grid grid-cols-8 grid-rows-20 gap-1.5 relative overflow-hidden">
        ...
        <div className="elem col-span-1 row-span-1" style={{ "--r": 3, "--c": 3, gridRowStart: 3, gridColumnStart: 3 }}>
        ...
        <div className="elem col-span-1 row-span-1" style={{ "--r": 12, "--c": 4, gridRowStart: 12, gridColumnStart: 4 }}>
        ...
        <div className="elem col-span-1 row-span-1" style={{ "--r": 11, "--c": 2, gridRowStart: 11, gridColumnStart: 2 }}>
        ...
        <div className="elem col-span-1 row-span-1" style={{ "--r": 12, "--c": 6, gridRowStart: 12, gridColumnStart: 6 }}>
        ...
        <div className="elem col-span-1 row-span-1" style={{ "--r": 15, "--c": 7, gridRowStart: 15, gridColumnStart: 7 }}>
        ...
        <div className="elem col-span-1 row-span-1" style={{ "--r": 7, "--c": 7, gridRowStart: 7, gridColumnStart: 7 }}>
        ...
        <div className="elem col-span-1 row-span-1" style={{ "--r": 3, "--c": 7, gridRowStart: 3, gridColumnStart: 7 }}>
        ...
        <div className="elem col-span-1 row-span-1" style={{ "--r": 9, "--c": 7, gridRowStart: 9, gridColumnStart: 7 }}>
        ...
        <div className="elem col-span-1 row-span-1" style={{ "--r": 6, "--c": 2, gridRowStart: 6, gridColumnStart: 2 }}>
      ...
      <div className="w-full h-[300vh] bg-[#FEA903] py-96 relative z-[999] overflow-hidden"
        style={{
          WebkitMaskImage: "linear-gradient(to bottom, rgba(254,169,3,0.2) -20%, rgba(254,169,3,0.97) 25%, rgb(243, 162, 0) 50%)"
        }}>
